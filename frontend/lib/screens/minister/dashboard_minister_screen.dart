...
class DashboardMinisterScreen extends StatefulWidget {
  const DashboardMinisterScreen({super.key});

  @override
  State<DashboardMinisterScreen> createState() => _DashboardMinisterScreenState();
}

class _DashboardMinisterScreenState extends State<DashboardMinisterScreen> {
    ...
    return Column(
      children: [
        ...
        ListTile(
          ...
          onTap: () => context.go('/minister/announcement'),
        ),
        const Spacer(),
